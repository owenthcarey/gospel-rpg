...
The reviewed reading surfaces measure **7.05:1–11.06:1** text contrast on desktop and phone; [computed measurements](verification/connected-journey-reading.json) accompany the regression assertions. Reviewed browser views show [Continue](verification/connected-journey-continue-phone.png), [a saved route](verification/connected-journey-route-phone.png), return dialogue on [desktop](verification/connected-journey-home-desktop.png) and [phone](verification/connected-journey-home-phone.png), a [portable journey recap](verification/connected-journey-recap-desktop.png), the [closing recap in phone landscape](verification/connected-journey-recap-phone.png), [status filtering](verification/connected-journey-status-phone.png), the [replay library](verification/connected-journey-library.png), [large-text replay in landscape](verification/connected-journey-replay-landscape.png), the completed shore on [desktop](verification/connected-journey-shore-desktop.png) and [phone](verification/connected-journey-shore-phone.png), and the [passage marker](verification/connected-journey-passage-desktop.png).
