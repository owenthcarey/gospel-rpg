...
Blender MCP generated the eight additions and isolated workshop, then independently imported the shipped exports. Review corrected overlapping channel floors, elbow walls, receiving inlets, and runtime orientation. The [original connected channel](verification/living-galilee-channel.png) and [hashed asset inventory](verification/living-galilee-assets.json) accompany the recipes. The later [refined kit and resting-place review](verification/rfc008/README.md#assets-and-reproducibility) retains the updated sheets; the earlier kit and resting-place captures have been retired. Existing unchanged exports retain their previous bytes. Unrelated Blender scenes were preserved.
