...
- **71 original Blender assets**, fourteen skinned character variants, sixteen shared clips and three specialized procession clips, including walking, carrying, sitting, rowing, hauling and kneeling.
...
- Autosave, three manual slots, JSON export/import and **v7 migration from v1–v6 saves**, including interrupted lake scenes and remembered choices.
...
This delivers three bounded Gospel chapters and seven optional stories. More of Galilee/Judea, open-water sailing, offline caching and full device/accessibility review remain ahead. See the [roadmap](docs/ROADMAP.md), [current milestone RFC](docs/rfcs/004-the-road-to-nain.md), and [verification record](docs/VERIFICATION.md).
