...
export const environmentProfiles: Record<RegionId | 'title', EnvironmentProfile> = {
  ...
  'gathering-house': {
    ...
    sun: { azimuth: 2.6, elevation: 0.9, color: '#fff0d8', intensity: 0.9, disc: 0 },
    fill: { sky: '#e6ddcb', ground: '#7a6650', intensity: 0.62 },
    fog: { color: '#50493e', density: 0 },
    grade: { exposure: 1.04, contrast: 1.06, saturation: 0.97, warmth: 0.16, vignette: 0.45 },
    bloom: 0.16,
    shadow: { darkness: 0.72, extent: 12 },
    wind: 0,
    clouds: 0,
    horizon: null,
    interior: true,
  ...
  bakehouse: {
    ...
    sun: { azimuth: 2.9, elevation: 0.85, color: '#ffeccf', intensity: 0.88, disc: 0 },
    fill: { sky: '#e9dcc6', ground: '#7d6650', intensity: 0.64 },
    fog: { color: '#50493e', density: 0 },
    grade: { exposure: 1.05, contrast: 1.06, saturation: 0.98, warmth: 0.22, vignette: 0.45 },
    bloom: 0.2,
    shadow: { darkness: 0.72, extent: 12 },
    wind: 0,
    clouds: 0,
